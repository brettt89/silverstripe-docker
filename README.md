...
- [`8.2-apache-bullseye`, `8.2-apache`, `8.2`](https://github.com/brettt89/silverstripe-docker/blob/master/src/8.2/apache/bullseye/Dockerfile)
- [`8.2-apache-buster`](https://github.com/brettt89/silverstripe-docker/blob/master/src/8.2/apache/Dockerfile)
- [`8.2-fpm-bullseye`, `8.2-fpm`](https://github.com/brettt89/silverstripe-docker/blob/master/src/8.2/fpm/bullseye/Dockerfile)
- [`8.2-fpm-buster`](https://github.com/brettt89/silverstripe-docker/blob/master/src/8.2/fpm/buster/Dockerfile)
- [`8.2-fpm-alpine`](https://github.com/brettt89/silverstripe-docker/blob/master/src/8.2/fpm/alpine/Dockerfile)
- [`8.2-cli-bullseye`, `8.2-cli`](https://github.com/brettt89/silverstripe-docker/blob/master/src/8.2/cli/bullseye/Dockerfile)
- [`8.2-cli-buster`](https://github.com/brettt89/silverstripe-docker/blob/master/src/8.2/cli/buster/Dockerfile)
